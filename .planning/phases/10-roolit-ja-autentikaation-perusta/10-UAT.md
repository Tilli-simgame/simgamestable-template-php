...
updated: 2026-07-16T08:41:06Z
---

## Current Test

number: 1
name: Aja database/migrate_roles.sql ja vahvista admin_users-taulun sarakkeet
expected: |
  admin_users saa role ENUM('admin','mod','author') ja is_active TINYINT(1) -sarakkeet; admin-tunnus role='admin', is_active=1. Kirjaudu admin-tunnuksella -> $_SESSION['admin_role']='admin' kirjoittuu ja kirjautuminen onnistuu.
